...
{
	var $table = 'wilayah_kecamatan';
	var $column_order = array('kec_id', 'kot_nama', 'kec_nama'); //set column field database for datatable orderable
	var $column_search = array('kec_id', 'kot_nama', 'kec_nama'); //set column field database for datatable searchable just firstname , lastname , address are searchable
	var $order = array('kec_nama' => 'asc'); // default order
	...
	private function _get_datatables_query()
	{
		...
		$this->db_wilayah->join('wilayah_kabupaten', 'kab_id = kabupaten_id', 'left');
		$i = 0;
	...
	public function cari_data_kecamatan($id)
	{
		$this->db_wilayah->from($this->table);
		$this->db_wilayah->where('kec_id', $id);
		$query = $this->db_wilayah->get();
	...
	{
		$this->db_wilayah->from('wilayah_kabupaten');
		$query = $this->db_wilayah->get();
